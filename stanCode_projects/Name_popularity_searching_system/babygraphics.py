...
def get_x_coordinate(width, year_index):
    ...
    in the YEARS list, returns the x coordinate座標 of the vertical
    ...
    """
    # calculate the space between 2 vertical lines and return x position of each year
...
def main():
    ...
    # Tkinter是可以將Python程式碼變成圖形化介面(GUI)的套件庫，裡面給了很多一般圖形化介面的基本物件
    top = tkinter.Tk()  # GUI的核心，需要用這個函式建立架構
